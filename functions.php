...
function _s_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Banner Widget Area', '_s' ),
		'id'            => 'banner',
		'description'   => esc_html__( 'Add banner area widgets here.', '_s' ),
		'before_widget' => '<section id="%1$s" class="banner-widget %2$s">',
	...
	register_sidebar( array(
		...
		'id'            => 'footer',
		'description'   => esc_html__( 'Add footer widgets here.', '_s' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
/**
 * Enqueues a script, using the file-modified time as the version for cache busting
 *
 * @param string $handle
 * @param string $relative_path The path relative to the theme directory, including the leading forward slash
 * @return void
 */
function _s_enqueue_script( $handle, $relative_path ) {
	wp_enqueue_script( $handle, get_template_directory_uri() . $relative_path, array(), filemtime( get_template_directory() . $relative_path ), true );
}
